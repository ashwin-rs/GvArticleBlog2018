...
bootstrap-blog is distributed under the terms of the GNU General Public License v2


== Installation ==
	
1. In your admin panel, go to Appearance > Themes and click the Add New button.
2. Click Upload and Choose File, then select the bootstrap-blog.zip file. Click Install Now.
3. Click Activate to use your new theme right away.
4. Go to Customiser -> Home Page Setting -> Select -> Static Front Page -> Select Any page
5. Create categories, pages and post
6. Select category needed for the homepage

Bootstrap Blog WordPress Theme, Copyright 2018 The Bootstrap Themes
Bootstrap Blog is distributed under the terms of the GNU GPL
...
= Changelog =
	...
	= Version 1.0.5 =
		...
		Release Date: Oct 2, 2018
			i)  Footer credit added


	= Version 1.0.4 =

		Release Date: September 17, 2018
			i)  CSS for new child theme
	...
	= Version 1.0.3 =
		...
		Release Date: August 30, 2018
			i)  Image path for Child Theme


	= Version 1.0.2 =

		Release Date: August 21, 2018
			i)  Child Theme Compatible


	= Version 1.0.1 =

		Release Date: August 15, 2018
			i)  Image update for header/slider/featured section
...
* Image licences Used in screenshot - https://pixabay.com/en/people-girl-woman-alone-fashion-2565564/
License: Creative Commons CC0 - Free for commercial use.

* Image licences Used in screenshot - https://pixabay.com/en/people-woman-girl-female-shopping-2594683/
License: Creative Commons CC0 - Free for commercial use.

* Image licences Used in screenshot - https://pixabay.com/en/fashion-show-fashion-catwalk-model-1746581/
License: Creative Commons CC0 - Free for commercial use.

* Image licences Used in screenshot - https://pixabay.com/en/adult-beautiful-beauty-cute-face-1867889/
License: Creative Commons CC0 - Free for commercial use.

* Image licences Used in screenshot - https://pixabay.com/en/girl-red-hair-makeup-wooden-wall-1828536/
License: Creative Commons CC0 - Free for commercial use.

* Image licences Used in screenshot - https://pixabay.com/en/girl-studio-light-beauty-fashion-1262800/
License: Creative Commons CC0 - Free for commercial use.
